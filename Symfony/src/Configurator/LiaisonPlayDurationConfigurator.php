...
/**
 * The LEGO configurator for LiaisonPlayDuration */
class LiaisonPlayDurationConfigurator extends AbstractDoctrineORMConfigurator
{

    const ENTITY_CLASS_NAME = LiaisonPlayDuration::class;
    const TITLE = 'Gestion des liaisonplaydurations';
